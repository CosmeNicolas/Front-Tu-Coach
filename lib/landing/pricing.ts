...
function saasPrice(amount: number, launchDiscount: number, offerLabel: string) {
  return {
    price: formatArs(amount),
    period: '/mes',
    launchPrice: formatArs(launchMonthPrice(amount, launchDiscount)),
    launchCaption: 'primer mes',
    badge: offerLabel,
  };
}

export function buildLandingPlansFromPricing(
  pricing: PublicPlatformPricing,
): {
  saasPlans: LandingPlan[];
  catalogPlans: LandingPlan[];
  trialDays: number;
  offerLabel: string;
} {
  const offerLabel = pricing.launchOfferLabel;
  const trialDays = pricing.trialDays;

  const saasPlans: LandingPlan[] = [
    {
      id: 'free',
      name: 'Free',
    ...
    },
    {
      ...
      ...saasPrice(pricing.premiumMonth, pricing.launchDiscount, offerLabel),
      features: [
        `${trialDays} días de prueba al registrarte`,
        'Hasta 50 alumnos',
        'Hasta 50 planificaciones activas',
        'Asistente, plantillas y videos propios',
        'Chat y métricas avanzadas',
      ],
      cta: `Probar ${trialDays} días`,
      href: REGISTRO_ROUTE,
      highlighted: true,
    },
    {
      ...
      ...saasPrice(pricing.proMonth, pricing.launchDiscount, offerLabel),
      features: [
        'Todo Premium',
        'Hasta 200 alumnos',
    ...
    },
    {
      ...
      ...saasPrice(pricing.plusMonth, pricing.launchDiscount, offerLabel),
      features: [
        'Todo Pro',
  ...
  const catalogPlans: LandingPlan[] = [
    {
      id: 'catalog-4',
      name: '4 semanas',
      subtitle: 'Salud, fuerza o hipertrofia',
      price: formatArs(pricing.catalog4w),
      period: 'el bloque',
      features: [
    ...
    },
    {
      ...
      price: formatArs(pricing.catalog8w),
      period: 'el bloque',
      features: [
        'Plan genérico de catálogo',
        'Kg y reps sugeridos',
    ...
    },
    {
      ...
      name: '12 semanas',
      subtitle: 'Salud, fuerza o hipertrofia',
      price: formatArs(pricing.catalog12w),
      period: 'el bloque',
      features: [
        'Plan genérico de catálogo',
        'Kg y reps sugeridos',
    ...
    },
    {
      ...
      price: formatArs(pricing.personalized),
      period: 'el bloque',
      features: [
  ...
  return { saasPlans, catalogPlans, trialDays, offerLabel };
}
...
export const LANDING_SAAS_PLANS: LandingPlan[] = [
  ...
  },
  {
    ...
    name: 'Premium',
    subtitle: 'Para entrenadores',
    ...saasPrice(PRICE_ARS.premiumMonth, 0.6, LAUNCH_OFFER_LABEL),
    features: [
  ...
  },
  {
    ...
    name: 'Pro',
    subtitle: 'Para estudios grandes',
    ...saasPrice(PRICE_ARS.proMonth, 0.6, LAUNCH_OFFER_LABEL),
    features: [
      'Todo Premium',
      'Hasta 200 alumnos',
      'Hasta 200 planificaciones activas',
  ...
  },
  {
    ...
    name: 'Plus',
    subtitle: 'Para operaciones más grandes',
    ...saasPrice(PRICE_ARS.plusMonth, 0.6, LAUNCH_OFFER_LABEL),
    features: [
      'Todo Pro',
      'Más capacidad, la coordinamos con vos',
      'Prioridad de soporte',
