...
export default function AlumnoDetallePage({
  ...
  if (isLoading) return <div className="p-8 text-sm text-zinc-500">Cargando…</div>;
  if (!data) return <div className="p-8 text-sm text-zinc-500">Alumno no encontrado</div>;
