...
export function AlumnoSessionStopwatch({
  ...
  return (
    <div
      className={cn(
        'flex shrink-0 flex-col items-center rounded-xl border border-border bg-muted/30 px-3 py-2 sm:min-w-[148px]',
    ...
    >
      ...
      <p
        className="mt-0.5 font-mono text-xl font-bold tabular-nums tracking-tight text-foreground sm:text-2xl"
        aria-live="polite"
      ...
      {!readOnly ? (
        ...
        <p className="mt-1 text-[10px] text-muted-foreground">Tiempo registrado</p>
      ) : null}
    </div>
  );
}
