import { buildLandingSteps } from '@/lib/landing/steps';
...
export function HowItWorksSection({ trialDays = TRIAL_DAYS }: HowItWorksSectionProps) {
  const steps = buildLandingSteps(trialDays);
  return (
